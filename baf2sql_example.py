...
# Opens a BAF analysis and plots some data.
#
# See C# and C++ examples for more usage examples.
...
if len(sys.argv) > 1:
    ...
    raise RuntimeError('Need .d analysis directory as first argument.')
